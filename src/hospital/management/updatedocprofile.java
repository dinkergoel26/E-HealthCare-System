...
public class updatedocprofile extends javax.swing.JFrame {

    /**
     * Creates new form updatedocprofile
     */
    public updatedocprofile() {
        initComponents();
        setLocationRelativeTo(null);
         int m;
        try{
            m=Integer.parseInt(loginpage.c);
            new connect();
            Statement st=connect.C.createStatement();
            ResultSet rs=st.executeQuery("select * from doctor where LoginID='"+m+"'");
            while(rs.next())
            {
               ...
               // l3.setText(rs.getString("Gender"));
                ...
                t2.setText(rs.getString("Qualification"));
                t3.setText(rs.getString("Specialization"));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try{
            ...
            new connect();
            Statement st=connect.C.createStatement();
            st.executeUpdate("update doctor set Name='"+t1.getText()+"' , DOB='"+cb+"' , Gender='"+str+"' , Address='"+ta1.getText()+"' , Qualification='"+t2.getText()+"' , Specialization='"+t3.getText()+"' , Contact='"+t4.getText()+"' where LoginID='"+s+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(updatedocprofile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new updatedocprofile().setVisible(true);
            }
        });
    }
